...
namespace Examen_certifiant_BLOC3C__Leveil_John.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "Le mot de passe doit comporter au moins 6 et au maximum 100 caractères.", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "Le mot de passe et le mot de passe confirmer sont différent.")]
